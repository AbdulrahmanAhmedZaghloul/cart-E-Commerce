...
export function ProductWoman() {
    ...
    // Filter products related to Women's Fashion
    const filteredProducts = products.filter(product => product?.category?.name === "Women's Fashion");
        ...
        <React.Fragment>
            ...
            <div id="" className='container mx-auto my-4 px-4'>
                <div className='py-2'>
                    ...
                    <Link to={'/productWoman'} className='text-gray-400 font-mono'>   Women's Fashion</Link>
                </div>
