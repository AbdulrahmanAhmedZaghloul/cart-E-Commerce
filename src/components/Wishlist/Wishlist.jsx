...
import wishlistimage from "../../image/no-wishlist-8316267-6632287 (1).png"; // Import the image for an empty wishlist
                ...
                {loadinger ? (
                    ...
                    <div className="flex flex-wrap ">
                        {Array.isArray(list?.data) && list.data.length > 0 ? (
                            list.data.map((prot) => (
                                <div key={prot._id} className="lg:w-1/5 py-5 md:w-1/3 sm:w-1/2 w-full group/item transition-all overflow-hidden   p-3">
                                    <div className="pb-4 relative shadow rounded-lg">
                            ...
                            <div className="w-full flex flex-col h-[50vh] items-center mx-auto px-6 justify-center">
