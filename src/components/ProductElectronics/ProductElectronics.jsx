...
function ProductElectronics() {
    ...
    // Filter products related to Electronics
    const filteredProducts = products.filter(product => product?.category?.name === "Electronics");
        ...
        <React.Fragment>
            ...
            <div id="" className='container mx-auto my-4 px-4'>
                <div className='py-2'>
                    ...
                    <Link to={'/productElectronics'} className='text-gray-400 font-mono'>Electronics</Link>
                </div>
